...
% Developed a tool based on intuition... except for monitoring tasks 

We seek to answer the following research questions and determine the validity of our hypotheses:

%What tools do people use? Modalities (IDEs, CLIs, Consoles)
% People tend to gravitate away from consoles the more expert they get
% Based on your task, those distinctions may blur
% Is there a trend as expertise grows away from consoles?
...
%CNCF cloud survey findings (total number of Kubernetes developers and operators) 
% Check out how they determine Kubernetes expertise ^ 
...
%Table \ref{table:t6} provides a list of all the input measures we collected and defines how we counted these inputs in each tool interface.
...
%Kui correlates preference and improves the metrics....
